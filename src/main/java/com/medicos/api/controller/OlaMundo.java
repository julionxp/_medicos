...
@RestController // Informa ao spring boot que a classe olaMundo é uma classe cdo tipo controladora.

public class OlaMundo {
    @GetMapping // Informa que o método será invocado quando get acontecer
